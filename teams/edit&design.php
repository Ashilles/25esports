...
<?php $title="Designers"; require_once(__DIR__."/../sources/backend/metas.php");$memb = ""; ?>
...
<body class="back-darken">
	...
	<div class="col-12 text-white mx-auto text-center mt-5"><h1 style="color: orange;">Designers & Editors</h1><small>Team</small></div>	
		<div class="container pt-2 pl-5 pr-5 mx-auto">
			<div class="row">
				<?php 

				foreach ($json['designers']['members'] as $member) {
					...
					<div class="col-4 mt-4">
						...
						echo '<hr class="m-0 bg-white mb-2 mx-auto text-center" width="50">
							...
							<h6 class="mb-2"><span>&starf;</span> Member</h6>
						</div>
					</div>	
		...
		<div class="container pt-2 pl-5 pr-5 mx-auto">
			<!-- <h4 style="color: #fff;" class="mt-4">&succ; Editors</h4><hr class="bg-white mx-0" style="box-shadow: 3px 3px 3px rgba(0,0,0,0.25);" width="200"> -->
			<div class="row">
				<?php 

				foreach ($json['editors']['members'] as $member) {
	...
	<div class="container" style="background-image: url('/sources/assets/media/bg2.png');background-size: 1500px;background-repeat: no-repeat;background-color: #1E1C27;">
	</div>
</body>
</html>