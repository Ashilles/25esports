...
<?php $title="Fifa"; require_once(__DIR__."/../sources/backend/metas.php");$memb = ""; ?>
...
<body class="back-darken">
	...
	<div class="col-12 text-white mx-auto text-center mt-5"><h1 style="color: orange;">Fifa</h1><small>Team</small></div>	
		<div class="container pt-2 pl-5 pr-5 mx-auto">
			<div class="row">
				<?php 

				foreach ($json['fifa']['members'] as $member) {
